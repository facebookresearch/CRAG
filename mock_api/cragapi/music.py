...
class MusicKG(object):
    def __init__(self):
        ...
        artist_dict_path = os.path.join(
            KG_BASE_DIRECTORY, "music", "artist_dict_simplified.pickle"
        )
        ...
        song_dict_path = os.path.join(
            KG_BASE_DIRECTORY, "music", "song_dict_simplified.pickle"
        )
        ...
        rank_dict_hot_path = os.path.join(
            KG_BASE_DIRECTORY, "music", "rank_dict_hot100.pickle"
        )
        ...
        song_dict_hot_path = os.path.join(
            KG_BASE_DIRECTORY, "music", "song_dict_hot100.pickle"
        )
        ...
        artist_work_dict_path = os.path.join(
            KG_BASE_DIRECTORY, "music", "artist_work_dict.pickle"
        )
    ...
    def grammy_get_best_artist_by_year(self, year):
        ...
        if year < 1957 or year > 2019:
            ...
            filtered_df = self.grammy_df[
                (self.grammy_df["category"] == "Best New Artist")
                & (self.grammy_df["year"] == year)
            ]
    ...
    def grammy_get_award_count_by_artist(self, artist_name):
        ...
        return (
            total_unique_rows_nominee
            + total_unique_rows_artist
            + total_unique_rows_worker
        )
    ...
    def grammy_get_award_count_by_song(self, song_name):
        ...
        Returns:
            the number of total awards (int)
        """
        total_unique_rows_nominee = len(
            self.grammy_df[self.grammy_df["nominee"] == song_name]
        )
    ...
    def grammy_get_best_song_by_year(self, year):
        ...
        if year < 1957 or year > 2019:
            ...
            filtered_df = self.grammy_df[
                (self.grammy_df["category"] == "Song Of The Year")
                & (self.grammy_df["year"] == year)
            ]
    ...
    def grammy_get_best_album_by_year(self, year):
        ...
        if year < 1957 or year > 2019:
            ...
            filtered_df = self.grammy_df[
                (self.grammy_df["category"] == "Album Of The Year")
                & (self.grammy_df["year"] == year)
            ]
            song_list = filtered_df["nominee"].tolist()
            return song_list
    ...
    def grammy_get_all_awarded_artists(self):
        ...
        """
        nominee_values = (
            self.grammy_df[self.grammy_df["category"] == "Best New Artist"]["nominee"]
            .dropna()
            .unique()
            .tolist()
        )
